...
| gen | [:x:](pA/gen)<br>[data](pA/gen/data) | [:x:](pB/gen)<br>[data](pB/gen/data) | [:white_check_mark:](pC/gen) | [:x:](pD/gen)<br>[gen.cpp](pD/gen/gen.cpp)<br>[data](pD/gen/data) |
...
| tests | [:white_check_mark:](pA/tests)<br>[Auto build disabled](pA/gen/DISABLE_AUTO_BUILD) | [:white_check_mark:](pB/tests) | [:x:](pC/tests) | [:x:](pD/tests)<br>[Auto build disabled](pD/gen/DISABLE_AUTO_BUILD) |
